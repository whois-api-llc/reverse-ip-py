...
class ParameterError(ReverseIpApiError):
    pass


class EmptyApiKeyError(ReverseIpApiError):
    pass


class ResponseError(ReverseIpApiError):
    def __init__(self, message):
        self.message = message
...
class HttpApiError(ReverseIpApiError):
    pass


class CannotRetrieveNextPageError(ReverseIpApiError):
    pass
